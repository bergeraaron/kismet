...
void kis_datasource_hble::handle_rx_packet(kis_packet *packet) {
    typedef struct {
...
**/
    ...
    memcpy(conv_header->payload, &cc_chunk->data[10], cc_payload_len);
    ...
    radioheader->freq_khz = (2400 + (chan)) * 1000;
